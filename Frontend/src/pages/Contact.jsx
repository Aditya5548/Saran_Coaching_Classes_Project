  ...
  return <>
    ...
    <section className="py-12 sm:py-16 md:py-20"><div className="container-shell grid gap-8 lg:grid-cols-[.7fr_1.3fr]">
      <div className="space-y-4">
        ...
        <MapCard />
        <div className="rounded-[1.5rem] border border-slate-200 bg-white p-5 shadow-soft"><div className="text-[10px] font-extrabold uppercase tracking-[.16em] text-slate-500">Stay connected</div><p className="mt=2 text-sm leading-6 text-slate-500">Follow Saranesh for updates, learning tips and announcements.</p><div className="mt=4 rounded-2xl bg-ink p=3"><SocialLinks compact /></div></div>
      </div>
      <ContactForm />
    </div></section>
  </>;
