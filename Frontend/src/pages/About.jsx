...
export default function About() {
  return <>
    <PageHeader eyebrow="About Saranesh Edu Hub" title="A local learning and service centre built around practical help." text="Saranesh Edu Hub combines coaching and tuition with admission guidance, online services, government/job form assistance, cyber services, property information and technology solutions." image="/assets/logo.png" />
