    ...
    <footer className="bg-ink text-white">
      <div className="container-shell py-12 sm:py-14 md:py-16">
        <div className="grid gap-10 lg:grid-cols-[1.15fr_.75fr_1fr]">
          <div>
            <div className="flex items-center gap-3"><img src="/assets/logo.png" alt="Saranesh Edu Hub" className="h-12 w-12 rounded-xl bg-white object-contain" /><div><div className="font-display text-2xl">Saranesh Edu Hub</div><div className="text-[9px] font-bold uppercase tracking-[.18em] text-slate-400">Coaching & Services</div></div></div>
