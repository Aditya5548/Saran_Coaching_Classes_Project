  ...
  return (
    <a href={site.receiverMap} target="_blank" rel="noreferrer" className="group block overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-soft transition hover:-translate-y-1">
      <div className="relative h-48 overflow-hidden bg-[#ddd7ca] sm:h-56">
        <iframe title="Saranesh Edu Hub Coaching Classes location map" src="https://www.google.com/maps?q=26.8854,81.0715&z=14&output=embed" className="h-full w-full border-0 grayscale-[0.25]" loading="lazy" />
      ...
      <div className="flex items-center justify-between gap-4 p-5">
        <div><div className="flex items-center gap-2 text-sm font-extrabold"><MapPin size={16} className="text-gold" /> Saranesh Edu Hub Coaching Classes</div><p className="mt-2 text-xs text-slate-500">{site.coordinates}</p></div>
